...
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzQPZ_ri1FmJBTwhGOIh-qYT4Xtqb2nwRX3n4Q8nWezAaK8j4Sg-nih6zU0A2-0JEjs/exec';
...
async function scriptPost(payload) {
  ...
  try {
    ...
    if (!text.includes('ok')) throw new Error('Script error: ' + text.slice(0,100));
  }
}
